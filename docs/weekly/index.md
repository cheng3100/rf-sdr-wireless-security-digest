...
### [第 3 期修订：Black Hat 无线研究、MeshCore 与接收机同步](2026-08-14.md)

**原始文本：** [首次发布](../raw/2026-08-14.md) · [本次高价值来源测试原文](../raw/2026-08-14-02.md)

**主题入口：** [软件项目](2026-08-14.md#software) · [软硬件项目](2026-08-14.md#hardware-software) · [RF / Wireless 动态](2026-08-14.md#news) · [会议研究](../conference-research/index.md) · [RF 原理精读](2026-08-14.md#fundamentals)

本次测试首次按“高价值来源优先”策略检索：软件方向重点看 SDRangel 的 MeshCore Rx/Tx 插件、SatDump 2.0 Alpha 与已归档的 URH 基线价值；软硬件方向继续关注 PortaPack Mayhem 中 TETRA/VOR/EPIRB 等设备端应用和 Maia SDR 的 FPGA/Linux 分层。动态部分重点从 Black Hat USA 2026 提取 6 GHz Wi-Fi AFC 安全研究与 Red Team SIGINT 课程，体现共享频谱控制面和 mission-critical radio 正进入主流安全研究视野。此后这类具有完整研究链路的会议材料将单独进入“会议研究”主题；原理精读继续维护 PySDR 等长期学习材料。
